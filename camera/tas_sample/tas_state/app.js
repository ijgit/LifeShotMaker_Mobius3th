...
function set_cam(comm_num){
    //var cmd = 'python servo.py ' + comm_num;
    //var cmd = 'sudo ./led ' + comm_num;
    //exec(cmd, function callback(error, stdout, stderr) {
    //console.log(stdout);
    if (comm_num == "1") {
        fs.writeFile('../../degree.txt', '1450', function (err) {
            console.log('reset degree.txt');
            fs.writeFile('../../degree2.txt', '1450', function (err) {
                console.log('reset degree2.txt');
                fs.writeFile('../Cam01/index.txt', '0', function (err) {
                    console.log('reset camIndex.txt');
                });
            });
        });
    }
    //});
    //control_stream(comm_num);
    setTimeout(function () {
        //if(comm_num == "1"){
